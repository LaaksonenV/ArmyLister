...
void ListCreator::CreateArmy(QWidget *parent)
{
    ...
    creator.info_->setText(
                ...
                " !~<AA> This items points count also to category "
                "AA.\n"
                ...
                " §[AA] Creates an list with name 'AA', and with "
                "items below it. These lists can then be used in "
                "items with '[List name]'.\n"
                " §{AA}'Limit' Creates a grouplimiter with name 'AA'. "
                "Limit options are '=X' to limit groups items for "
                "whole army (eg. §{AA}=1), "
                "and '#X' for one unit (eg. 1{AA}#2).\n"
                " §R Marks item(/unit) as retinue item, which may "
                "be included as an option for other item.\n"
